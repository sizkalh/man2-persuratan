...
--
-- Host: localhost:3306
-- Waktu pembuatan: 15 Nov 2022 pada 20.51
...
--
-- Database: `mandua_surat`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_berita_acara`
--
...
--
-- Struktur dari tabel `tbl_detail_surat`
--
...
(74, '197309082005012002', 'YAYUK WINARTI, S.Pd. M.Pd.', 'P', '085235171055', 'Jln. Pahlawan, Ds. Ketanon, Kec. Kedungwaru, Kab. Tulungagung', 'buyayukaksel@gmail.com', '197309082005012002', '202cb962ac59075b964b07152d234b70', '123', 'guru', 'guru', 'Pembina', 'IV/a', 'GURU', 'TULUNGAGUNG', '1973-09-08', '-', 'MAN 2 Tulungagung'),
...
--
-- Struktur dari tabel `tbl_surat_balasan`
--
...
--
-- Struktur dari tabel `tbl_surat_dispen`
--
...
--
-- Struktur dari tabel `tbl_surat_izin_penelitian`
--
...
--
-- Struktur dari tabel `tbl_surat_kuasa`
--

CREATE TABLE `tbl_surat_kuasa` (
  `id_surat_kuasa` int(10) NOT NULL,
...
--
-- Struktur dari tabel `tbl_surat_kurikulum`
--
...
--
-- Struktur dari tabel `tbl_surat_pernyataan`
--
...
--
-- Struktur dari tabel `tbl_tanda_tangan`
--
...
--
-- Dumping data untuk tabel `tbl_tanda_tangan`
--

INSERT INTO `tbl_tanda_tangan` (`id`, `id_surat`, `id_user`, `status`, `status_notif`, `catatan`, `tgl_proses`) VALUES
(1, 1, 1, 'cek', 'diajukan', NULL, NULL),
(2, 1, 4, 'diterima', 'diterima', 'benar', '2022-11-11 14:46:53'),
(3, 1, 3, 'diterima', 'diterima', 'acc', '2022-11-11 14:46:18'),
(4, 1, 2, 'diterima', 'diterima', 'acc', '2022-11-11 14:45:59'),
(5, 1, 107, 'diterima', 'diterima', '', '2022-11-11 14:43:54'),
(6, 2, 1, 'cek', 'diajukan', NULL, NULL),
(7, 2, 4, 'diterima', 'diterima', 'betul', '2022-11-11 14:37:36'),
(8, 2, 3, 'diterima', 'diterima', 'acc', '2022-11-11 14:36:55'),
(9, 2, 2, 'diterima', 'diterima', 'acc', '2022-11-11 14:35:38'),
(10, 2, 5, 'diterima', 'diterima', '', '2022-11-11 14:31:45'),
(11, 3, 1, 'belum', 'belum', NULL, NULL),
(12, 3, 4, 'ditolak', 'ditolak', '', '2022-11-11 14:53:22'),
(13, 3, 3, 'ditolak', 'ditolak', 'salah', '2022-11-11 14:54:14'),
(14, 3, 2, 'cek', 'ditolak', 'acc', '2022-11-11 14:33:49'),
(15, 3, 69, 'diterima', 'diterima', '', '2022-11-11 14:30:17'),
(16, 4, 1, 'belum', 'belum', NULL, NULL),
(17, 4, 4, 'belum', 'belum', NULL, NULL),
(18, 4, 3, 'belum', 'belum', NULL, NULL),
(19, 4, 2, 'ditolak', 'ditolak', 'tanggal salah', '2022-11-11 14:21:20'),
(20, 4, 89, 'cek', 'ditolak', '', '2022-11-11 14:13:10'),
(21, 5, 1, 'belum', 'belum', NULL, NULL),
(22, 5, 4, 'belum', 'belum', NULL, NULL),
(23, 5, 3, 'belum', 'belum', NULL, NULL),
(24, 5, 2, 'cek', 'diajukan', 'tanggal salah', '2022-11-11 14:18:16'),
(25, 5, 86, 'diterima', 'diterima', '', '2022-11-11 14:42:22'),
(26, 6, 1, 'belum', 'belum', NULL, NULL),
(27, 6, 4, 'belum', 'belum', NULL, NULL),
(28, 6, 3, 'cek', 'diajukan', NULL, NULL),
(29, 6, 2, 'diterima', 'diterima', 'acc', '2022-11-11 14:33:24'),
(30, 6, 74, 'diterima', 'diterima', '', '2022-11-11 14:30:40'),
(31, 7, 1, 'belum', 'belum', NULL, NULL),
(32, 7, 4, 'belum', 'belum', NULL, NULL),
(33, 7, 3, 'belum', 'belum', NULL, NULL),
(34, 7, 2, 'cek', 'diajukan', 'tanggal salah', '2022-11-11 14:17:48'),
(35, 7, 85, 'diterima', 'diterima', '', '2022-11-11 14:33:07'),
(36, 8, 1, 'belum', 'belum', NULL, NULL),
(37, 8, 4, 'belum', 'belum', NULL, NULL),
(38, 8, 3, 'belum', 'belum', NULL, NULL),
(39, 8, 2, 'ditolak', 'ditolak', 'tanggal salah', '2022-11-11 14:25:04'),
(40, 8, 67, 'cek', 'ditolak', '', '2022-11-11 14:22:00'),
(41, 9, 1, 'belum', 'belum', NULL, NULL),
(42, 9, 4, 'belum', 'belum', NULL, NULL),
(43, 9, 3, 'belum', 'belum', NULL, NULL),
(44, 9, 2, 'belum', 'belum', NULL, NULL),
(45, 9, 5, 'cek', 'belum', NULL, NULL),
(46, 10, 1, 'belum', 'belum', NULL, NULL),
(47, 10, 4, 'belum', 'belum', NULL, NULL),
(48, 10, 3, 'belum', 'belum', NULL, NULL),
(49, 10, 2, 'cek', 'diajukan', NULL, NULL),
(50, 10, 74, 'diterima', 'diterima', '', '2022-11-11 15:21:20');
...
--
-- Indeks untuk tabel `tbl_berita_acara`
--
...
--
-- Indeks untuk tabel `tbl_detail_surat`
--
...
--
-- Indeks untuk tabel `tbl_surat_balasan`
--
ALTER TABLE `tbl_surat_balasan`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tbl_surat_dispen`
--
ALTER TABLE `tbl_surat_dispen`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tbl_surat_izin_penelitian`
--
ALTER TABLE `tbl_surat_izin_penelitian`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `tbl_surat_kuasa`
--
ALTER TABLE `tbl_surat_kuasa`
  ADD PRIMARY KEY (`id_surat_kuasa`);

--
-- Indeks untuk tabel `tbl_surat_kurikulum`
--
ALTER TABLE `tbl_surat_kurikulum`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `tbl_surat_pernyataan`
--
ALTER TABLE `tbl_surat_pernyataan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `tbl_tanda_tangan`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_berita_acara`
--
ALTER TABLE `tbl_berita_acara`
...
--
ALTER TABLE `tbl_detail_kelas`
  MODIFY `id_detail_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_surat_balasan`
--
ALTER TABLE `tbl_surat_balasan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_surat_dispen`
--
ALTER TABLE `tbl_surat_dispen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_surat_izin_penelitian`
--
ALTER TABLE `tbl_surat_izin_penelitian`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_surat_kuasa`
--
ALTER TABLE `tbl_surat_kuasa`
  MODIFY `id_surat_kuasa` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_surat_kurikulum`
--
ALTER TABLE `tbl_surat_kurikulum`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_surat_pernyataan`
--
ALTER TABLE `tbl_surat_pernyataan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_tanda_tangan`
--
ALTER TABLE `tbl_tanda_tangan`
