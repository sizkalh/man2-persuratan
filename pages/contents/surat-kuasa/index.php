        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="<?= base_url() ?>surat-kuasa/create" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Kuasa</a>
                </div>
            <?php } ?>
            <div class="box-body">
...
<script>
    $(document).ready(function() {
        ...
        function getDataSurat(id_surat) {
            $.ajax({
                method: "POST",
                url: base_url + "/process/surat-kuasa/getDataSurat.php",
                data: {
                    id_surat: id_surat
                },
                dataType: "json",
                success: function(data) {
                    ...
                    $.ajax({
                        method: "POST",
                        url: base_url + "/process/surat-kuasa/getDataTtd.php",
                        data: {
                            id_surat: id_surat
                        },
                        dataType: "json",
        ...
        function tandaTangan(id_surat, pangkat, komentar, no_surat) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        method: "POST",
                        url: base_url + "/process/surat-kuasa/tandaTangan.php",
                        data: {
                            id_surat: id_surat,
                            pangkat: pangkat,
                            catatan: komentar,
                        ...
                        success: function(data) {
                            if (data.status == "sukses") {
                                ...
                                setInterval(function() {
                                    window.location.href = base_url + "/surat-kuasa/index";
                                }, 1700);
                            } else {
                                swalWithBootstrapButtons.fire(
                                    'Gagal',
        ...
        function tolakTandaTangan(id_surat, pangkat, komentar) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        method: "POST",
                        url: base_url + "/process/surat-kuasa/tolakTandaTangan.php",
                        data: {
                            id_surat: id_surat,
                            pangkat: pangkat,
                            catatan: komentar
