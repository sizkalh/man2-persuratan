<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-body">
                <form action="<?= base_url() ?>process/surat-pemberitahuan/tambah.php" enctype="multipart/form-data" method="post" id="form_surat_pemberitahuan">
                    ...
                    <div class="form-group">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="alamat" value="Tempat" placeholder="Masukkan Alamat Tujuan" readonly />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="perihal" rows="3" placeholder="Masukkan Perihal" readonly>Pemberitahuan</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $("#preview").click(function() {
            ...
            var data = $("#form_surat_pemberitahuan").serialize();

            window.open(
                base_url + '/process/surat-pemberitahuan/preview.php?' + data,
