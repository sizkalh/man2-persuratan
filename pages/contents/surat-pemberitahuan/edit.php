    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-body">
                ...
                ?>
                    <form action="<?= base_url() ?>process/surat-pemberitahuan/update.php" enctype="multipart/form-data" method="post" id="form_surat_pemberitahuan">
                        ...
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="perihal" rows="3" placeholder="Masukkan Perihal" readonly><?= $data['perihal'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
