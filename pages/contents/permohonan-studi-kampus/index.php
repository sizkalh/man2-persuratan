        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="<?= base_url() ?>permohonan-studi-kampus/create" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Permohonan Studi Kampus</a>
                </div>
            <?php } ?>
            <div class="box-body">
                <table class="table table-condensed table-hover" id="nota_dinas">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Drs. Lorem ipsum</td>
                            <td class="text-center">660088</td>
                            <td>SMP 2 Merdeka</td>
                            <td class="text-center">
                                <a href="#" class="btn btn-default btn-sm"><i class="fa fa-paperclip"></i></a>
                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-default">
                        ...
                        <tr>
                            ...
                            <td>Drs. Lorem ipsum</td>
                            <td class="text-center">660077</td>
                            <td>SMP 3 Merdeka</td>
                            <td class="text-center">
                                <a href="#" class="btn btn-default btn-sm"><i class="fa fa-paperclip"></i></a>
                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal-default">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Berkas Pengajuan Permohonan Studi Kampus</h4>
                    </div>
