<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-success">
      <div class="box-body">
        <form action="<?= base_url() ?>process/surat-pengantar/tambah.php" enctype="multipart/form-data" method="post" id="form_surat_pengantar">
          ...
          <div class="form-group">
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="keterangan" rows="3" placeholder="Masukkan Kalimat Tujuan"></textarea>
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" name="catatan" rows="3" placeholder="Masukkan Materi"></textarea>
              </div>
            </div>
          </div>
          <div class="form-group">
...
<script>
  $(document).ready(function() {
    ...
    $("#preview").click(function() {
      ...
      var data = $("#form_surat_pengantar").serialize();
