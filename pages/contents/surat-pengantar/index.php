        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="<?= base_url() ?>surat-pengantar/create" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Pengantar</a>
                </div>
            <?php } ?>
            <div class="box-body">
                        ...
                        while ($cek_jabatan = mysqli_fetch_array($id_user)) {
                            if ($cek_jabatan['pangkat'] == 'guru') {
                                $data = mysqli_query($koneksi, "SELECT
                                                                ...
                                                                WHERE tbl_surat.jenis = 'surat_pengantar' 
                                    ...
                                    <td class="text-center">
                                        ...
                                        if (mysqli_num_rows($cek_lampiran) > 0) {
                                            while ($data_lampiran = mysqli_fetch_array($cek_lampiran)) { ?>
                                                ...
                                                <a href="../../../upload/<?= $data_lampiran['file'] ?>" target="_blank" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="File lampiran"><i class="fa fa-paperclip"></i></a>
                                        <?php }
                                        } ?>
                                        ...
                                        <a href="<?= base_url() ?>process/surat-pengantar/preview_d.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="top" title="Lihat Surat">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        ...
                                        if (mysqli_num_rows($cek_ttd) > 0) {
                                            while ($ttd = mysqli_fetch_array($cek_ttd)) { ?>
                                                <a href="<?= base_url() ?>process/surat-pengantar/print.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
                                            <?php }
                                        } else { ?>
                                        ...
                                        ?>
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= base_url() ?>surat-pengantar/edit?id=<?= $myData['id']; ?>" id="edit_surat" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                        <?php }
                                        } ?>
                                        ...
                                        ?>
                                            <a href="../../../process/surat-pengantar/hapus.php?id=<?= $myData['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                    </tr>
                            <?php }
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="keterangan" rows="3" disabled></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="catatan" rows="3" disabled></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        success: function(data) {
                            if (data.status == "sukses") {
                                ...
                                setInterval(function() {
                                    window.location.href = base_url + "/surat-pengantar/index";
                                }, 1700);
                            } else {
                                swalWithBootstrapButtons.fire(
                                    'Gagal',
