                        ...
                        while ($cek_jabatan = mysqli_fetch_array($id_user)) {
                            if ($cek_jabatan['pangkat'] == 'guru') {
                                $data = mysqli_query($koneksi, "SELECT
                                                                ...
                                                                WHERE tbl_surat.jenis = 'surat_rekom_guru' 
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?= base_url() ?>process/surat-rekom-guru/preview_d.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat Surat">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        ...
                                        if (mysqli_num_rows($cek_ttd) > 0) {
                                            while ($ttd = mysqli_fetch_array($cek_ttd)) { ?>
                                                <a href="<?= base_url() ?>process/surat-rekom-guru/print.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
                                            <?php }
                                        } else { ?>
                                        ...
                                        ?>
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= base_url() ?>surat-rekom-guru/edit?id=<?= $myData['id']; ?>" id="edit_surat" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                        <?php }
                                        } ?>
                                        ...
                                        ?>
                                            <a href="../../../process/surat-rekom-guru/hapus.php?id=<?= $myData['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                    </tr>
                            <?php }
