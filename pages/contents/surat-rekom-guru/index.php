                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?= base_url() ?>process/surat-rekom-guru/preview_d.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="Lihat Surat">
                                            <i class="fa fa-eye"></i>
                                        </a>
