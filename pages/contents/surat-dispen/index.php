        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="<?= base_url() ?>surat-dispen/create" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Dispen</a>
                </div>
            <?php } ?>
            <div class="box-body">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Berkas Pengajuan Surat Dispen</h4>
                    </div>
