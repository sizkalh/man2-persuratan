                ...
                <table class="table table-condensed table-hover compact" style="table-layout: fixed;" width="100%" id="data-table5">
                    <thead>
                        <tr class="bg-navy">
                            ...
                            <th width="250">Dalam Rangka</th>
                            <th width="250">Penerima Tugas</th>
                        ...
                        while ($cek_jabatan = mysqli_fetch_array($id_user)) {
                            if ($cek_jabatan['pangkat'] == 'guru') {
                                $data = mysqli_query($koneksi, "SELECT
                                                                ...
                                                                WHERE tbl_surat.jenis = 'surat_tugas' 
                                ...
                                ?>
                                    ...
                                    <td <?php
                                        if (isset($_GET['data_id'])) {
                                            ...
                                            if ($myData['perihal'] == null || $myData['perihal'] == '') {
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?= base_url() ?>process/surat-tugas/preview_d.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Lihat Surat">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        ...
                                        if (mysqli_num_rows($cek_ttd) > 0) {
                                            while ($ttd = mysqli_fetch_array($cek_ttd)) { ?>
                                                <a href="<?= base_url() ?>process/surat-tugas/print.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-print"></i></a>
                                            <?php }
                                        } else { ?>
                                        ...
                                        ?>
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= base_url() ?>surat-tugas/create?id=<?= $myData['id']; ?>" id="edit_surat" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                        <?php }
                                        } ?>
                                        ...
                                        ?>
                                            <a href="../../../process/surat-tugas/hapus.php?id=<?= $myData['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                    </tr>
                            <?php }
