        ...
        <div class="box box-success">
            <div class="box-body">
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-building"></i>&nbsp;&nbsp;&nbsp;&nbsp; Nama Sekolah / Instansi</label>
                        <div class="col-sm-9">
                            <?= $data['nama_sekolah'] ?>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-map-marker"></i>&nbsp;&nbsp;&nbsp;&nbsp; Alamat Sekolah / Instansi</label>
                        <div class="col-sm-9">
                            <?= $data['alamat'] ?>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-phone"></i>&nbsp;&nbsp;&nbsp;&nbsp; No. Telp</label>
                        <div class="col-sm-9">
                            <?= $data['telp'] ?>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-globe"></i>&nbsp;&nbsp;&nbsp;&nbsp; Website</label>
                        <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-archive"></i>&nbsp;&nbsp;&nbsp;&nbsp; Kode POS</label>
                        <div class="col-sm-9">
                            <?= $data['kode_pos'] ?>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label"><i class="fa fa-credit-card"></i>&nbsp;&nbsp;&nbsp;&nbsp; NPSN</label>
                        <div class="col-sm-9">
                            <span><?= $data['npsn'] ?></span>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="box box-success" id="surat-terbit">
                        ...
                        <div class="box-body">
                            <table class="table table-condensed table-bordered table-hover compact nowrap" style="width: 100%;" id="data-table1">
                                <thead>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($data_surat_terbit['jenis'] == 'berita_acara') {
                                                    echo '<a href="' . base_url() . 'berita-acara/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'cuti_tahunan') {
                                                    echo '<a href="' . base_url() . 'cuti-tahunan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'nota_dinas') {
                                                    echo '<a href="' . base_url() . 'nota-dinas/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'permohonan_study') {
                                                    echo '<a href="' . base_url() . 'permohonan-study/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_kuasa') {
                                                    echo '<a href="' . base_url() . 'surat-kuasa/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'sppd') {
                                                    echo '<a href="' . base_url() . 'sppd/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_dispen') {
                                                    echo '<a href="' . base_url() . 'surat-dispen/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_kuasa') {
                                                    echo '<a href="' . base_url() . 'surat-kuasa/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_skkb') {
                                                    echo '<a href="' . base_url() . 'surat-skkb/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_tugas') {
                                                    echo '<a href="' . base_url() . 'surat-tugas/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_balasan') {
                                                    echo '<a href="' . base_url() . 'surat-balasan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_izin_kegiatan') {
                                                    echo '<a href="' . base_url() . 'surat-izin-kegiatan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_izin_penelitian') {
                                                    echo '<a href="' . base_url() . 'surat-izin-penelitian/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'suket_pengganti_ijazah') {
                                                    echo '<a href="' . base_url() . 'suket-pengganti-ijazah/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'suket_siswa') {
                                                    echo '<a href="' . base_url() . 'suket-siswa/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'suket_guru') {
                                                    echo '<a href="' . base_url() . 'suket-guru/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_mutasi_siswa_keluar') {
                                                    echo '<a href="' . base_url() . 'surat-mutasi-siswa-keluar/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_mutasi_siswa_masuk') {
                                                    echo '<a href="' . base_url() . 'surat-mutasi-siswa-masuk/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_panggilan') {
                                                    echo '<a href="' . base_url() . 'surat-panggilan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_pemberitahuan') {
                                                    echo '<a href="' . base_url() . 'surat-pemberitahuan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_pengantar') {
                                                    echo '<a href="' . base_url() . 'surat-pengantar/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_permohonan_narasumber') {
                                                    echo '<a href="' . base_url() . 'surat-permohonan-narasumber/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_pernyataan') {
                                                    echo '<a href="' . base_url() . 'surat-pernyataan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_pesanan') {
                                                    echo '<a href="' . base_url() . 'surat-pesanan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_rekom_guru') {
                                                    echo '<a href="' . base_url() . 'surat-rekom-guru/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_rekom_siswa') {
                                                    echo '<a href="' . base_url() . 'surat-rekom-siswa/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                } else if ($data_surat_terbit['jenis'] == 'surat_undangan') {
                                                    echo '<a href="' . base_url() . 'surat-undangan/index?data_id=' . $data_surat_terbit['id_surat'] . '">';
                                                }
                                                ?>
        ...
        <div class="row">
            <div class="<?= $_SESSION['pangkat_user'] != 'siswa' ? 'col-md-6' : 'col-md-12' ?>" id="guru">
                <div class="box">
                    ...
                    <div class="box-body">
                        <table class="table table-condensed table-bordered table-hover compact nowrap" id="data-table5">
                            <thead>
                                <tr>
                                    <th width="30" class="text-center">No</th>
                                    <th>Data Diri</th>
