        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="<?= base_url() ?>berita-acara/create" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Berita Acara</a>
                </div>
            <?php } ?>
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        while ($cek_jabatan = mysqli_fetch_array($id_user)) {
                            if ($cek_jabatan['pangkat'] == 'guru') {
                                $data = mysqli_query($koneksi, "SELECT * FROM tbl_surat WHERE jenis='berita_acara' AND id_pemohon = '" . $_SESSION['id_user'] . "' ORDER BY id DESC");
                            } else {
                                $data = mysqli_query($koneksi, "SELECT * FROM tbl_surat WHERE jenis='berita_acara' ORDER BY id DESC");
                            }
                        }
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= base_url() ?>berita-acara/edit?id=<?= $myData['id']; ?>" id="edit_surat" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                        <?php }
                                        } ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Berkas Pengajuan Berita Acara</h4>
                    </div>
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama_pertama" name="nama_pertama" placeholder="Masukkan Nama" readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nip_pertama" name="nip_pertama" placeholder="Masukkan Nama" readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="jabatan_pertama" name="jabatan_pertama" placeholder="Masukkan Nama" readonly />
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <div class="mb-3 row">
                                    <label class="col-sm-2 col-form-label">Nama</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nama_kedua" name="nama_kedua" placeholder="Masukkan Nama" readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3 row">
                                    <label class="col-sm-2 col-form-label">NIP</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="nip_kedua" name="nip_kedua" placeholder="Masukkan NIP" readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="mb-3 row">
                                    <label class="col-sm-2 col-form-label">Jabatan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="jabatan_kedua" name="jabatan_kedua" placeholder="Masukkan Jabatan" readonly />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tgl_pelaksanaan" id="tanggal_pelaksanaan" autocomplete="off" placeholder=" Masukkan Tgl. Pelaksanaan" readonly />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        function getDataSurat(id_surat) {
            $.ajax({
                method: "POST",
                url: base_url + "/process/berita-acara/getDataSurat.php",
                data: {
                    id_surat: id_surat
                },
                dataType: "json",
                success: function(data) {
                    ...
                    $('#nip_pertama').val(data.nip_pertama);
                    $('#jabatan_pertama').val(data.jabatan_pertama);
                    $('#nama_kedua').val(data.nama_kedua);
                    $('#nip_kedua').val(data.nip_kedua);
                    $('#jabatan_kedua').val(data.jabatan_kedua);
                        ...
                        success: function(data) {
                            if (data.status == "sukses") {
                                ...
                                setInterval(function() {
                                    window.location.href = base_url + "/berita-acara/index";
                                }, 1700);
                            } else {
                                swalWithBootstrapButtons.fire(
                                    'Gagal',
