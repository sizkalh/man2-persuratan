<?php 
    ...
    $query = mysqli_query($koneksi, 'insert into tbl_surat set jenis="'.$jenis_surat.'", kepada="'.$id_guru. '", tgl_pembuatan="'.$new_tanggal_pembuatan.'", id_pemohon = "'.$_SESSION['id_user'].'", hapus = "n"');
    ...
    $query = mysqli_query($koneksi, 'insert into tbl_surat_izin_penelitian set id_surat = "' . $id_surat . '", nama_mhs="'.$nama_mhs.'", nim="'.$nim. '", jurusan="'. $jurusan. '", semester="' . $semester . '", kampus="' . $kampus . '", judul="' . $judul . '", tanggal_mulai="' . $tanggal_mulai . '", tanggal_selesai="' . $tanggal_selesai . '"');
