<?php
    ...
    $query = mysqli_query($koneksi, 'UPDATE tbl_surat set jenis="' . $jenis_surat . '", hari="' . $hari . '", tgl_pelaksanaan="' . $new_tanggal_pelaksanaan . '", waktu="' . $waktu . '", tempat="' . $tempat . '", kepada="' . $kepada . '", alamat="' . $alamat . '", perihal="' . $perihal . '", keterangan="' . $dalam_rangka . '", catatan="' . $materi . '", tgl_pembuatan="' . $new_tanggal_pembuatan . '" WHERE id="' . $id . '"');
