...
$query_ttd = mysqli_query($koneksi, 'UPDATE tbl_tanda_tangan SET STATUS="ditolak", status_notif="belum", catatan = "' . $catatan . '", tgl_proses = "' . $tgl_proses . '" WHERE id_surat="' . $id_surat . '" AND id_user ="' . $id_user . '"');
