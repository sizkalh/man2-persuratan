<?php 
    ...
    $query = mysqli_query($koneksi, 'insert into tbl_surat set jenis="'.$jenis_surat.'", kepada="'.$kepada. '", keterangan="'.$keterangan. '", perihal="' . $perihal . '", catatan="' . $catatan . '", tgl_pembuatan="'.$new_tanggal_pembuatan.'", id_pemohon = "'.$_SESSION['id_user'].'", hapus = "n"');
