...
?>
  ...
  <body>
    <div style="margin-top: -50px; margin-lft: 40px; margin right: 40px">
      <table style="margin: 0 auto; border-collapse: collapse;">
        ...
        <tr>
          ...
          <td>
            ...
            <br />
            Kepala Madrasah,
            <img style="position: absolute; max-width: 220px; left: 21em; margin-top: 0em;" src="../../dist/img/ttd/contohttd.png">
            <br />
            <br>
            <br>
            <br>
            <br>
            Muhamad Dopir <img style="max-height: 21px;" src="../../dist/img/ttd/paraf.png"><br>
          </td>
        </tr>
      </table>
    </div>
