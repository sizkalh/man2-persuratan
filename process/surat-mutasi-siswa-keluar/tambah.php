<?php 
    ...
    $query = mysqli_query($koneksi, 'insert into tbl_surat set jenis="'.$jenis_surat.'", kepada="'.$kepada. '", perihal="'.$perihal.'", keterangan="'.$dalam_rangka. '", catatan="' . $catatan . '", tgl_pembuatan="'.$new_tanggal_pembuatan.'", id_pemohon = "'.$_SESSION['id_user'].'", hapus = "n"');
