    ...
    <section class="content">
        ...
        <div class="box box-success">
            <div class="box-header">
                <a href="tambah_sk_siswa.php" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Keterangan Siswa</a>
            </div>
            <div class="box-body">
                <table class="table table-condensed table-hover" id="nota_dinas">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">1110088800</td>
        ...
        <div class="modal fade" id="modal-default">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <p class="lead text-green">Yang bertanda tangan dibawah ini Kepala Madrasah Aliyah Negeri 2 Tulungagung :</p>
                        ...
                        <div class="form-group">
                            <p class="lead text-green">Menerangkan dengan sesungguhnya bahwa :</p>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" disabled />
