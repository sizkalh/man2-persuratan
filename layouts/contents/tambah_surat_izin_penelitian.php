            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="Masukkan Fakultas / Jurusan" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="3" placeholder="Masukkan Judul Penelitian"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker" placeholder="Masukkan Tanggal Awal Penelitian" />
                                <span class="input-group-addon">s.d.</span>
                                <input type="text" class="form-control datepicker" placeholder="Masukkan Tanggal Akhir Penelitian" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <a href="surat_izin_penelitian.php" class="btn btn-default"><i class="fa fa-times"></i> Batal</a>
