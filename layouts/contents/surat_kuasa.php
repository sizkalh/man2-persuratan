        ...
        <div class="box box-success">
            ...
            ?>
                <div class="box-header">
                    <a href="tambah_surat_kuasa.php" class="btn btn-primary"><i class="fa fa-plus"></i> Buat Surat Kuasa</a>
                </div>
            <?php } ?>
            <div class="box-body">
                            ...
                            <td class="text-center">
                                ...
                                <?php
                                    ...
                                    ?>
                                        ...
                                        <?php } else { ?>
                                            <a href="edit_surat_kuasa.php?id=<?= $myData['id']; ?>" id="edit_surat" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                    <?php }
                                } ?>
                                ...
                                <?php
                                    ...
                                    ?>
                                        <a href="../../proses/surat_kuasa/hapus.php?id=<?= $myData['id']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                <?php } ?>
                                    ...
                                    if ($_SESSION['pangkat_user'] == "guru" || $_SESSION['pangkat_user'] == "operator"){
                                        ...
                                        if (mysqli_num_rows($cek_ttd) > 0) {
                                            while ($ttd = mysqli_fetch_array($cek_ttd)) { ?>
                                                <a href="print_surat_kuasa.php?id=<?= $myData['id'] ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i></a>
                                            <?php }
                                        } else { ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Berkas Pengajuan Surat Kuasa</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <p class="lead text-green">Yang Memberi Kuasa</p>
                        <div class="form-group">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" id="pemberi_kuasa" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="pangkat" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="jabatan_pemberi_kuasa" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="instansi" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <p class="lead text-green">Yang Diberi Kuasa</p>
                        <div class="form-group">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="text" id="penerima_kuasa" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Jabatan</label>
                                <div class="col-sm-10">
                                    <input type="text" id="jabatan_penerima_kuasa" class="form-control" disabled />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="ket" rows="3" disabled></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        function getDataSurat(id_surat) {
            $.ajax({
                method: "POST",
                url: base_url + "/layouts/contents/proses/surat_kuasa/getDataSurat.php",
                data: {
                    id_surat: id_surat
                },
                dataType: "json",
                success: function(data) {
                    ...
                    $('#pemberi_kuasa').val(data.pemberi_kuasa);
                    $('#nip').val(data.nip);
                    $('#pangkat').val(data.pangkat);
                    $('#jabatan_pemberi_kuasa').val(data.jabatan_pemberi_kuasa);
                    $('#instansi').val(data.instansi);
                    $('#penerima_kuasa').val(data.penerima_kuasa);
                    $('#tempat_lahir').val(data.tempat_lahir);
                    $('#tanggal_lahir').val(data.tanggal_lahir);
                    $('#jabatan_penerima_kuasa').val(data.jabatan_penerima_kuasa);
                    $('#ket').val(data.ket);

                    $.ajax({
                        method: "POST",
                        url: base_url + "/layouts/contents/proses/surat_kuasa/getDataTtd.php",
                        data: {
                            id_surat: id_surat
                        },
                        dataType: "json",
        ...
        function tandaTangan(id_surat, pangkat, komentar, no_surat) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        method: "POST",
                        url: base_url + "/layouts/contents/proses/surat_kuasa/tandaTangan.php",
                        data: {
                            id_surat: id_surat,
                            pangkat: pangkat,
                            catatan: komentar,
                        ...
                        success: function(data) {
                            if (data.status == "sukses") {
                                ...
                                setInterval(function() {
                                    window.location.href = base_url + "/layouts/contents/surat_kuasa.php";
                                }, 1700);
                            } else {
                                swalWithBootstrapButtons.fire(
                                    'Gagal',
        ...
        function tolakTandaTangan(id_surat, pangkat, komentar) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        method: "POST",
                        url: base_url + "/layouts/contents/proses/surat_kuasa/tolakTandaTangan.php",
                        data: {
                            id_surat: id_surat,
                            pangkat: pangkat,
                            catatan: komentar
